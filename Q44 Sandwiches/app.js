...
// of the sandwich that is being ordered. Call the function three times, using a different number of arguments each 
// time.
function Sandwiches(...Items) {
    console.log(`I want ${Items}`);
}
Sandwiches("BBQ", "Tikka", "Fajita");
Sandwiches("Fajita", "BBQ");
Sandwiches("Tikka");
